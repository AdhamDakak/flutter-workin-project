...
import 'package:workinv2/Screens/JobsAppliedForScreenn.dart';
import 'package:workinv2/Screens/home_Screen.dart';
import 'package:workinv2/Screens/personalInfo2_Screen.dart';
...
import 'package:workinv2/controllers/JobsAppliedFor.dart';
...
class _userPrivateProfileState extends State<userPrivateProfile> {
  ...
  Future<void>jobsapplied(BuildContext context)async{
    await Provider.of<jobsAppliedForView>(context,listen: false).delete();
              ...
              children: [
                ...
                Wrap(
                    ...
                    children: List<Widget>.generate(Provider.of<userDetailView>(context,listen:false).count, (index){
                      return Chip(label: Text('${Provider.of<userDetailView>(context,listen:false).skill[index]}'),backgroundColor: scaffoldcolor,side:BorderSide(color: Colors.black) ,);
                    })
                ),
                SizedBox(height: 10,),
                Row(
