...
import 'package:workinv2/Screens/companyProfileScreen_private.dart';
...
//   void initState() {
//     _jobDescription.text=Provider.of<Edit>(context,listen: false).description==''?'':Provider.of<Edit>(context,listen: false).description;
//     _CareerLevelSelectedValue=Provider.of<Edit>(context,listen: false).careerlevel==''?'':Provider.of<Edit>(context,listen: false).careerlevel;
//     _yearsOfExperienceNeededSelectedValue=Provider.of<Edit>(context,listen: false).experience==''?'':Provider.of<Edit>(context,listen: false).experience;
//     _CurrentEducationLevelSelectedValue=Provider.of<Edit>(context,listen: false).education==''?'':Provider.of<Edit>(context,listen: false).education;
//     _jobRequirements.text=Provider.of<Edit>(context,listen: false).requirements==''?'':Provider.of<Edit>(context,listen: false).requirements;
//     if(Provider.of<Edit>(context,listen: false).salary==''||Provider.of<Edit>(context,listen: false).salary=='Confidential salary'){
...
//   List<String> listOfYearsOfExperienceNeeded = ['0', '1-3', '4-6', 'Above 6'];
//   List<String> listOfCurrentEducationLevel = ['Student', 'Bachelor','graduate', 'UnderGrad', 'Masters', 'PHD'];
//
//
//   String? get _JobDescriptionValidation {
//
...
//   }
//
//   Widget inputFile({label, subtitle, obscureText = false , TextInputType , hintText, required TextEditingController controller,errorText,onChangedText})
//   {
//     return Column(
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: <Widget>[
...
//               ),
//               SizedBox(height: 20,),
//               maxLineInputFile( label: "Job description",hintText: "Write a description about your job opportunity" , controller: _jobDescription, errorText: _JobDescriptionValidation , onChangedText:  _textJobDescription ),
//               SizedBox(height: 10,),
//               Text('Job details',
//                 style: GoogleFonts.nunito(fontSize: 25,fontWeight: FontWeight.bold),),
//               SizedBox(height: 10,),
...
//               ),
//               SizedBox(height: 10,),
//               inputFile(label: "Salary" ,subtitle: "Entering it help us suggest for you candidates" ,TextInputType: TextInputType.number, hintText: "5000" ,controller: _salary,errorText: _SalaryValidation , onChangedText:_textSalary ,),
//               SizedBox(height: 10,),
//               FormField<bool>(
//                 builder: (state) {
//                   return Column(
...
//               ),
//               SizedBox(height: 10,),
//               maxLineInputFile( label: "Job requirements",hintText: "-job requirements\n-skills\n-tools\n" , controller: _jobRequirements, errorText: _JobRequirementsValidation , onChangedText:  _textJobRequirements ),
//               SizedBox(height: 15,),
//               MaterialButton(
//                 minWidth: 285,
//                 color: primarycolor,
//                 height: 50,
//                 onPressed: () async {
//                   id=Provider.of<Edit>(context,listen: false).id;
//                   await register( _jobDescription.text,
//                     _salary.text,_jobRequirements.text, _CareerLevelSelectedValue.toString(),_yearsOfExperienceNeededSelectedValue.toString(),_CurrentEducationLevelSelectedValue.toString(),isConfidential.toString(),id);
//                 },
//                 elevation: 0,
//                 shape: RoundedRectangleBorder(
//                   borderRadius: BorderRadius.circular(50),
...
//
//   }
//   Future<void> register(jobDescription, salary, jobRequirements, careerLevelSelectedValue, yearsOfExperienceNeededSelectedValue, currentEducationLevelSelectedValue, isconfidential ,int id) async {
//     if (_JobDescriptionValidation == null && _JobRequirementsValidation == null && _SalaryValidation == null ) {
//       setState(() {
//         _isloading = true;
//       });
