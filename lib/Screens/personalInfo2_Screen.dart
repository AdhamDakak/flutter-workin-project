...
import 'package:workinv2/Screens/CareerInfo_Screen.dart';
...
//CvUploadScreen().createState().firstName.toString()
  ...
  void initState() {
    ...
    // _phonenumController.text=Provider.of<personalInfoAuth>(context,listen: false).num==""?"":Provider.of<personalInfoAuth>(context,listen: false).num;
    ...
    // _dateinput.text=Provider.of<personalInfoAuth>(context,listen: false).date==""?"":Provider.of<personalInfoAuth>(context,listen: false).date;
    // _selectedValue1=Provider.of<personalInfoAuth>(context,listen: false).nationality==""?"":Provider.of<personalInfoAuth>(context,listen: false).nationality;
    //
    // _selectedValue2=Provider.of<personalInfoAuth>(context,listen: false).country==""?"":Provider.of<personalInfoAuth>(context,listen: false).country;
    //  _selectedValue3=Provider.of<personalInfoAuth>(context,listen: false).city==""?"":Provider.of<personalInfoAuth>(context,listen: false).city;
    //  _selectedValue4=Provider.of<personalInfoAuth>(context,listen: false).area==""?"":Provider.of<personalInfoAuth>(context,listen: false).area;
